    ...
    <main class="main_container">
        ...
        <div class="center-content-wrapper">
            ...
            <div class="auth-section">
                <form on:submit|preventDefault={handleLogin} class="login-form">
                    <div class="input-row">
                        <input type="email" class="login-input" placeholder="E-Mail Adresse" bind:value={email} required>
                        <input type="password" class="login-input" name="password" placeholder="Passwort" bind:value={password} required>
                    </div>
                    <button type="submit" class="full-width-btn primary-btn">Einloggen</button>
                </form>

                <button class="full-width-btn secondary-btn" type="button" on:click={goReg}>
            ...
            <div class="guest-section">
                ...
                <button class="guest-btn" type="button" on:click={goGuest}>
        ...
        <section class="start-roles">
            ...
            <div class="start-roles-grid">
                <button class="role-card" type="button" on:click={goStudent}>
                    <span class="role-icon">🧒</span>
                    <span class="role-title">Schüler*in</span>
                </button>
                <button class="role-card" type="button" on:click={goTeacher}>
                    <span class="role-icon">👩‍🏫</span>
                    <span class="role-title">Lehrperson</span>
                </button>
                <button class="role-card" type="button" on:click={goParent}>
                    <span class="role-icon">👨‍👩‍👧</span>
