    ...
    async function saveQuestion() {
        ...
        try {
            const payload = {
                ...
                category: finalCategory, // Speichern
            ...
            <div class="modal" transition:scale={{ duration: 200, easing: quintOut, start: 0.95 }}>
                ...
                <div class="form-body">
                            ...
                            {:else}
                                <div class="input-group">
                                    <input
                                            ...
                                            autofocus
                                    />
                                    <button class="btn-small" onclick={() => isNewCategoryMode = false} title="Zurück zur Liste">✕</button>
                                </div>
                            {/if}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea rows="3" bind:value={draft.question} placeholder="z.B. Was ist 2 + 2?"></textarea>
                    </div>
