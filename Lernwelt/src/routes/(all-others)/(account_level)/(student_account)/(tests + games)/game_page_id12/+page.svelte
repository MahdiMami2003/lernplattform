...
<section class="hero">
    ...
    {#if avatarModal}
        <div class="modal-bg" on:click={() => (avatarModal = false)} role="button" tabindex="0" on:keydown={() => {}}></div>
        <div class="modal">
    ...
    {#if categoryModal}
        <div class="modal-bg" on:click={() => (categoryModal = false)} role="button" tabindex="0" on:keydown={() => {}}></div>
